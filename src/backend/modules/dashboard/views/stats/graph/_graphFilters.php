...
<div class="row">
    ...
    <div class="col-md-2">
        <?= Select2::widget([
            ...
            'options' => [
                ...
                'class' => 'form-control parent-depdropdown',
                'data-url' => Url::to(['/core/organization-ref-units/get-list', 'country_id' => 'idV', 'level' => OrganizationRefUnits::LEVEL_REGION, 'placeholder' => '--All Regions--']),
                'data-child-selectors' => [
    ...
    <div class="col-md-2 hidden">
        <?= Select2::widget([
            ...
            'options' => [
                ...
                'class' => 'form-control parent-depdropdown',
                'data-url' => Url::to(['/core/organization-ref-units/get-list', 'parent_id' => 'idV', 'level' => OrganizationRefUnits::LEVEL_DISTRICT, 'placeholder' => '--All Districts--']),
                'data-child-selectors' => [
                    '#' . $idPrefix . 'ward_id',
                ],
            ],
    ...
    <div class="col-md-2 hidden">
        <?= Select2::widget([
            ...
            'options' => [
                'id' => $idPrefix . 'ward_id',
                'class' => 'form-control parent-depdropdown',
                'data-url' => Url::to(['/core/organization-ref-units/get-list', 'parent_id' => 'idV', 'level' => OrganizationRefUnits::LEVEL_WARD, 'placeholder' => '--All Wards--']),
                'data-child-selectors' => [
                    '#' . $idPrefix . 'village_id',
                ],
            ],
    ...
    <div class="col-md-2 hidden">
        <?= Select2::widget([
            ...
            'options' => [
                ...
                'data-url' => Url::to(['/core/organization-ref-units/get-list', 'parent_id' => 'idV', 'level' => OrganizationRefUnits::LEVEL_VILLAGE, 'placeholder' => '--All Villages--']),
            ],
            'pluginOptions' => [
                'allowClear' => false
            ],
    ...
    <div class="col-sm-1"><?= Html::button('Go', ['class' => 'btn btn-primary', 'type' => 'submit'])?></div>
</div>
<br/>
