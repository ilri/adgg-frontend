                            ...
                            <div class="panel-body">
                                ...
                                foreach ($models as $name => $modelData) {
                                    ...
                                    <div class="collapse" id="collapse<?= $name ?>" style="">
                                        <div class="card card-body kt-scroll ps ps--active-y"
                            ...
                            <div class="panel-body pt-3 pr-3 pl-3">
                                <div id="queryOptions" class="hidden">
                                    ...
                                    <div class="row row-no-gutters mb-2">
                                        ...
                                        <div class="col-md-8"><input name="limit" id="limit" type="number" value=""
                                    ...
                                    <div class="mt-5">
                                        <button id="generateQuery" role="button"
                                                class="btn btn-primary col-md-8 offset-3">Preview Query
                                        </button>
                                    </div>
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8"><input name="name" id="name" type="text" value=""
                                                                     class="form-control form-control-sm"/></div>
                                    </div>
                                    <div class="mt-2">
                                        <button id="saveReport" role="button" class="btn btn-success col-md-8 offset-3">
