...
use backend\modules\core\forms\UploadHoofHealthEvent;
...
class HoofHealthEventController extends Controller
{
    ...
    public function init()
    {
        ...
        $this->resourceLabel = 'Hoof Health';
    }
    ...
    public function actionIndex($animal_id = null, $country_id = null, $org_id = null, $client_id = null, $region_id = null, $district_id = null, $ward_id = null, $village_id = null, $from = null, $to = null)
    {
        ...
        return $this->renderIndexAction(AnimalEvent::EVENT_TYPE_HOOF_HEALTH, $animal_id, $country_id, $org_id, $client_id, $region_id, $district_id, $ward_id, $village_id, $from, $to);
    }
    ...
    public function actionUpload()
    {
        ...
        $form = new UploadHoofHealthEvent(HoofHealthEvent::class);
        $resp = $this->uploadExcelConsole($form, 'hoof-health-event/index', Yii::$app->request->queryParams);
        if ($resp !== false) {
            return $resp;
        }
