    ...
    <div class="kt-profile__nav">
        <ul class="nav nav-tabs nav-tabs-line my-nav" role="tablist">
            <?php if (($model->animal_type == Animal::ANIMAL_TYPE_COW)): ?>
                ...
                <li class="nav-item">
                    <a class="nav-link" title="Click To View"
                       href="<?= Url::to(['animal-event/index', 'animal_id' => $model->id, 'event_type' => AnimalEvent::EVENT_TYPE_MILKING, 'country_id' => $model->country_id]) ?>"
                       role="tab">
                ...
                <li class="nav-item">
                    ...
                    <div class="dropdown-menu" x-placement="bottom-start">
                        <a class="dropdown-item" title="Click To View"
                           href="<?= Url::to(['animal-event/index', 'animal_id' => $model->id, 'event_type' => AnimalEvent::EVENT_TYPE_WEIGHTS, 'country_id' => $model->country_id]) ?>">
                            <?= Lang::t('Weights') ?>
                            <span class="badge badge-secondary badge-pill">
                        <?= AnimalEvent::getCount(['animal_id' => $model->id, 'event_type' => AnimalEvent::EVENT_TYPE_WEIGHTS, 'country_id' => $model->country_id]) ?>
                    </span>

                        </a>
                        <a class="dropdown-item" title="Click To View"
                           href="<?= Url::to(['animal-event/index', 'animal_id' => $model->id, 'event_type' => AnimalEvent::EVENT_TYPE_HEALTH, 'country_id' => $model->country_id]) ?>">
                            <?= Lang::t('Health') ?>
                            <span class="badge badge-secondary badge-pill">
                        <?= AnimalEvent::getCount(['animal_id' => $model->id, 'event_type' => AnimalEvent::EVENT_TYPE_HEALTH, 'country_id' => $model->country_id]) ?>
                    </span>
                        </a>
                    </div>
                </li>
