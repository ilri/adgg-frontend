                        ...
                        <div class="col-lg-2">
                            ...
                            <?= Select2::widget([
                                ...
                                'options' => [
                                    ...
                                    'placeholder' => '[select one]',
                                    'class' => 'form-control select2 parent-depdropdown',
                                    'data-url' => Url::to(['country-units/get-list', 'country_id' => 'idV', 'placeholder' => true, 'level' => CountryUnits::LEVEL_REGION]),
                        ...
                        <div class="col-lg-2">
                            ...
                            <?= Select2::widget([
                                ...
                                'options' => [
                                    ...
                                    'placeholder' => '[select one]',
                                    'class' => 'form-control select2 parent-depdropdown',
                                    'data-url' => Url::to(['country-units/get-list', 'parent_id' => 'idV', 'placeholder' => true, 'level' => CountryUnits::LEVEL_DISTRICT]),
                        ...
                        <div class="col-lg-2">
                            ...
                            <?= Select2::widget([
                                ...
                                'options' => [
                                    ...
                                    'class' => 'form-control select2 parent-depdropdown',
                                    'data-url' => Url::to(['country-units/get-list', 'parent_id' => 'idV', 'placeholder' => true, 'level' => CountryUnits::LEVEL_WARD]),
                        ...
                        <div class="col-lg-2">
                            ...
                            <?= Select2::widget([
                                ...
                                'options' => [
                                    ...
                                    'data-url' => Url::to(['country-units/get-list', 'parent_id' => 'idV', 'placeholder' => true, 'level' => CountryUnits::LEVEL_VILLAGE]),
