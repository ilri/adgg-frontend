...
class FeedingEvent extends AnimalEvent  implements ImportActiveRecordInterface, AnimalEventInterface
{
    ...
    public function getExcelColumns()
    {
        return [
            ...
            'event_date',
            'concentrate_cost',
            'concetrate_feed_is_used',
            'concetrate_information_source',
            'concetrate_information_source_other',
            'concetrate_propotion',
            'concetrate_purchase_where',
            'concetrate_purchase_where_other',
            'concetrate_types',
            'concetrate_types_other',
