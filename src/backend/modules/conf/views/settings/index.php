                    ...
                    $form = ActiveForm::begin([
                        ...
                        'fieldConfig' => [
                            ...
                            'horizontalCssClasses' => [
                                'label' => 'col-xl-3 col-lg-3 col-form-label',
                                'wrapper' => 'col-lg-9 col-xl-6',
                                'error' => '',
                                'hint' => '',
                            ],
                        ],
                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-section kt-section--first">
                            <div class="kt-section__body">
                                ...
                                <?php endif ?>
                                <?= $form->field($model, SystemSettings::KEY_DEFAULT_TIMEZONE)->dropDownList(Timezone::getListData()) ?>
                                <?= $form->field($model, SystemSettings::KEY_DEFAULT_COUNTRY)->dropDownList(Country::getListData()) ?>
                                <?= $form->field($model, SystemSettings::KEY_DEFAULT_CURRENCY)->dropDownList(Currency::getListData()) ?>
                                <?= $form->field($model, SystemSettings::KEY_PAGINATION_SIZE)->dropDownList(Utils::generateIntegersList(10, 500, 10)) ?>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="kt-section kt-section--first">
                                <div class="kt-section__body">
                                    <div class="alert alert-outline-danger fade show kt-margin-t-20 kt-margin-b-40"
                                        ...
                                        <div class="alert-text">Configure user passwords to expire periodically. Users
                                            will need warning that their passwords are going to expire, or they might
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="kt-checkbox-list">
                                                ...
                                                <label class="kt-checkbox">
                                                    <input type="checkbox" checked="checked"> Someone adds you as a
                                                    connection
                                                    <span></span>
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="kt-checkbox-list">
                                                ...
                                                <label class="kt-checkbox">
                                                    <input type="checkbox" checked="checked"> News about Keen on partner
                                                    products and other services
                                                    <span></span>
                                                </label>
                                                <label class="kt-checkbox">
                                                    <input type="checkbox" checked="checked"> Tips on Keen business
                                                    products
                                                    <span></span>
                                                </label>
                                            </div>
