...
use backend\modules\core\forms\UploadHoofTreatmentEvent;
use backend\modules\core\models\AnimalEvent;
use backend\modules\core\models\HoofTreatmentEvent;
use common\controllers\UploadExcelTrait;
use Yii;

class HoofTreatmentEventController extends Controller
{
    ...
    public function init()
    {
        ...
        $this->resourceLabel = 'Hoof Treatment Event';
    }
    ...
    public function actionIndex($animal_id = null, $country_id = null, $org_id = null, $client_id = null, $region_id = null, $district_id = null, $ward_id = null, $village_id = null, $from = null, $to = null)
    {
        ...
        return $this->renderIndexAction(AnimalEvent::EVENT_TYPE_HOOF_TREATMENT, $animal_id, $country_id, $org_id, $client_id, $region_id, $district_id, $ward_id, $village_id, $from, $to);
    }
    ...
    public function actionUpload()
    {
        ...
        $form = new UploadHoofTreatmentEvent(HoofTreatmentEvent::class);
