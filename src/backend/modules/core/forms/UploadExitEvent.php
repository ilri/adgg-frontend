...
class UploadExitEvent extends UploadAnimalEvent implements ImportInterface
{
    ...
    public function processExcelBatchData($batch)
    {
        ...
        $model = new ExitsEvent(['country_id' => $this->country_id, 'event_type' => $this->event_type]);
    ...
    {
        $this->_uploadType = ExcelImport::TYPE_ANIMAL_EVENT_EXITS;
    }
}