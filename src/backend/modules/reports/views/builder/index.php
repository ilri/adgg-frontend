                            ...
                            <div id="queryOptions" class="hidden">
                                ...
                                <div class="mt-4">
                                    <button id="askForName" role="button" class="btn btn-primary col-md-10"
                                            data-toggle="modal" data-target="#inputName">Generate & Save Report
                                    </button>
                                </div>
                                <div class="mt-2">
                                    <button id="generateQuery" role="button" class="btn btn-generatequery col-md-10">
                                        Preview Query
                                    </button>
                                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button id="saveReport" role="button" class="btn btn-success col-md-10 mx-auto">Generate & Save Report
                </button>
            </div>
        </div>
    </div>
