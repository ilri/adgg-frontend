 ...
 * @property OrganizationRefUnits[] $OrgRefUnits
 */
class OrganizationRef extends ActiveRecord implements ActiveSearchInterface
{
    use ActiveSearchTrait;

    const NUMBERING_FORMAT_ID = 'country_account_no';
    ...
    {
        return $this->hasMany(Users::class, ['country_id' => 'id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getCountryanizationRefUnits()
    {
        return $this->hasMany(OrganizationRefUnits::class, ['country_id' => 'id']);
    }
