...
class UploadParasiteInfectionEvent extends UploadAnimalEvent implements ImportInterface
{
    public function init()
    {
        parent::init();
        $this->event_type = AnimalEvent::EVENT_TYPE_VACCINATION;
        $this->sampleExcelFileName = 'vaccination-event.xlsx';
    }
    ...
    {
        $this->_uploadType = ExcelImport::TYPE_ANIMAL_EVENT_VACCINATION;
    }
}