...
class Constants
{
    ...
    const REPORT_TYPE_PEDIGREE_FILE = 3;
    const REPORT_TYPE_TESTDAY_MILKDATA = 4;
    const REPORT_TYPE_CALFDATA = 5;
    const REPORT_TYPE_TESTDAY_MILKDATA2 = 6;
    const REPORT_TYPE_PEDIGREE_FILE2 = 7;
    const REPORT_TYPE_HAIR_SAMPLING = 8;
