            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= Url::to(['/auth/user/index', 'org_id' => $model->id]) ?>"
                   role="tab">
                    <?= Lang::t('Users') ?>
                    <span class="badge badge-secondary badge-pill">
                        <?= Users::getCount(['org_id' => $model->id, 'level_id' => UserLevels::LEVEL_ORGANIZATION]) ?>
                    </span>
                </a>
            </li>
            <li class="nav-item">
                ...
                <div class="dropdown-menu" x-placement="bottom-start">
                    <?php if (Yii::$app->user->canUpdate()): ?>
                        ...
                        <a class="dropdown-item"
                           href="<?= Url::to(['/auth/user/create', 'level_id' => UserLevels::LEVEL_ORGANIZATION, 'org_id' => $model->id]) ?>">
                            <?= Lang::t('Add User') ?>
                        </a>
                        <?php if ($model->is_member): ?>
                            <a class="dropdown-item"
