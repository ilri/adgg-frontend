...
class Animal extends ActiveRecord implements ActiveSearchInterface, TableAttributeInterface, UploadExcelInterface, HighChartInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['farm_id', 'herd_id', 'country_id', 'region_id', 'district_id', 'ward_id', 'village_id', 'animal_type', 'is_derived_birthdate', 'sire_type', 'sire_id', 'dam_id', 'main_breed', 'breed_composition', 'entry_type', 'sex'], 'integer'],
            [['birthdate', 'deformities', 'entry_date', 'reg_date', 'secondary_breed', 'color'], 'safe'],
